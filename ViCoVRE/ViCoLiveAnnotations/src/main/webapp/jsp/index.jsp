...
<%@page import="com.googlecode.vicovre.annotations.live.Client"%>
<%@page import="com.googlecode.vicovre.annotations.live.Server"%>
        ...
        <c:otherwise>
            ...
            <script language="JavaScript">
                ...
                <crew:liveAnnotationClientLayout liveAnnotationTypeVar="liveAnnotationType"
                        ...
                        fieldsVar="fields" thumbnailVar="thumbnail">
                    if ('${buttonVisible}'!='false'){
                        ...
                        liveAnnotations['${liveAnnotationType}'].fields=${fields};
